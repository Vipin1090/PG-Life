...
if (mysqli_num_rows($result_1) > 0) {
    ...
    if (!$result_2) {
        echo json_encode(array("sucess" => false, "massage" => "Something went wrong"));
        return;
    } else {
    ...
    $sql_3 = "INSERT INTO interested_user_properties WHERE (user_id, property_id) VALUES ('$user_id','$property_id')";
